...
class CodeTest {
    ...
    void isKeypadValidTest() {
        ...
        char[][] wrongNotSequence2
                = {{'1', '2', '3'},
                {'4', '5', '6'},
                {'7', '8', '0'},
                {'A', 'B', '9'}};

        char[][] wrongNotSequenceT
                = {{'1', '5', '9'},
                {'2', '6', 'A'},
                {'3', '7', 'B'},
                {'4', '8', '0'}};

        char[][] wrongNotSequenceT2
                = {{'1', '5', '0'},
                {'2', '6', 'A'},
                {'3', '7', 'B'},
                {'4', '8', 'C'}};
        ...
        assertFalse(Code.isKeypadValid(badStart));
        assertFalse(Code.isKeypadValid(wrongDuplicates));
        assertFalse(Code.isKeypadValid(wrongDuplicates2));
        assertFalse(Code.isKeypadValid(wrongNotSequence));
        assertFalse(Code.isKeypadValid(wrongNotSequence2));
        assertFalse(Code.isKeypadValid(wrongNotSequenceT));
        assertFalse(Code.isKeypadValid(wrongNotSequenceT2));
